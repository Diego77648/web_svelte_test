...
<section id="hero">
  <div class="container">
    <article class="message">
      <h1 class="title"><span>Somos</span> ? Community</h1>
      <p class="text">
TEXTO3
      </p>
    </article>
    <article class="buttons">
      <Link external to={socials.DISCORD} btn primary fill large
        >Unirme a la comunidad</Link>
      <Button large on:click={() => scrollTo('#projects')}
